/* 685_sum3.c – CWE-685: Function Call With Incorrect Number of Arguments
 *
...
extern int  warduino_sum2(int a, int b, int c);   /* WRONG prototype: 3 param instead of 2 */
